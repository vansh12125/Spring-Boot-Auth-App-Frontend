...
export default function AuthPageScene3D() {
  ...
  return (
    <div className="w-full h-full min-h-screen relative bg-[#050507] overflow-hidden">
      ...
      <div className="absolute inset-0 lg:left-1/4 w-full lg:w-3/4 h-full flex items-center justify-center transform scale-75 sm:scale-90 transition-transform duration-500"></div>
      {loading && (
        <div>
          <LoadingAnimation
