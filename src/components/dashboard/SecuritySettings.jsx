    ...
    >
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between p-3.5 bg-white/[0.01] border border-white/5 rounded-xl">
          ...
          {provider.includes("GOOGLE") ? (
            <button className="text-[10px] font-mono px-2 py-0.5 bg-green-500/10 hover:bg-green-500/20 border border-green-500/20 rounded text-green-400 transition-colors">
              CONNECTED
            </button>
          ) : (
            <button className="text-[10px] font-mono px-2 py-0.5 bg-white/5 hover:bg-white/10 border border-white/5 rounded text-gray-300 transition-colors bg-red-500/10 hover:bg-red-500/20  text-red-400">
              DISCONNECTED
            </button>
          )}
        </div>
