...
export default function Contacts() {
  ...
  <div className="relative min-h-screen w-full flex items-center overflow-hidden bg-[#050507]">
      {/* Render the right-shifted 3D robot backdrop */}
      <RobotScene3D />
      
      {/* THE FIX: Added pointer-events-none to this row grid container.
          This enables mouse tracking coordinates to flow through the empty space directly to the background robot frame. */}
      <div className="max-w-7xl mx-auto w-full px-6 md:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-12 items-center min-h-screen pt-20 pb-16 pointer-events-none">
        ...
        {/* THE FIX: Bounded pointer-events-auto strictly onto the glass card block wrapper.
            All form inputs, text areas, and submission triggers remain perfectly functional and clickable. */}
        <motion.div 
        ...
        {/* Right-shifted structural spacing component columns matching the design profile framework */}
