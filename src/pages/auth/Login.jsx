          ...
          <div className="max-w-7xl mx-auto w-full px-6 md:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-12 items-center min-h-screen py-4">
            ...
            >
              <div className="mb-4">
                ...
                <p className="text-[11px] text-gray-400 mt-0.5">Sign in to your account to continue.</p>
              </div>
              <form onSubmit={(e) => e.preventDefault()} className="space-y-3">
                
                <div>
                  <label htmlFor="login-identity" className="block text-[9px] font-mono uppercase tracking-wider text-gray-400 mb-1">Username or Email</label>
                  <input 
                    type="text" 
                    name="identity"
                    id="login-identity"
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    <label htmlFor="login-password" className="block text-[9px] font-mono uppercase tracking-wider text-gray-400">Password</label>
                    <a href="#reset" className="text-[9px] font-mono text-gray-500 hover:text-white transition-colors">FORGOT PASSWORD?</a>
                  </div>
                  <input 
                    type="password" 
                    name="password"
                ...
                <div className="flex items-center pt-0.5">
                  ...
                  />
                  <label htmlFor="remember" className="ml-2 text-[10px] text-gray-400 font-mono leading-tight select-none cursor-pointer">
                    Remember me
                  </label>
                </div>
